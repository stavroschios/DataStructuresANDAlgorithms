package com.datastructuresANDalgorithms.three;
...
public class Array {
  ...
  public com.datastructures.two.Array intersect(com.datastructures.two.Array other) {
    var intersection = new com.datastructures.two.Array(count);
